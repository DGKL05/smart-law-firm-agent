...
(1, 1, '张明', '男', '13810000001', 'zhangming@mingde-law.example', '民事民法', '高级合伙人', 12, '长期处理婚姻家事、合同违约和侵权责任案件，擅长把复杂事实拆成可执行的诉讼策略。', '合同纠纷、婚姻家事、侵权责任', NULL, 1, 0),
(2, 1, '李清', '女', '13810000002', 'liqing@mingde-law.example', '公司企业', '合伙人律师', 9, '服务创业公司、制造企业和互联网企业，熟悉股权架构、劳动合规和合同体系搭建。', '股权设计、劳动合规、公司治理', NULL, 1, 0),
(3, 2, '王远', '男', '13810000003', 'wangyuan@zhixing-law.example', '涉外纠纷', '资深律师', 10, '具备涉外合同与国际商事争议处理经验，可提供中英双语法律咨询。', '涉外合同、跨境争议、仲裁', NULL, 1, 0),
(4, 2, '周若琳', '女', '13810000004', 'zhou@zhixing-law.example', '经济金融', '金融业务律师', 8, '曾参与银行、基金和融资租赁项目，关注交易结构、担保安排和争议预防。', '金融借款、担保纠纷、基金合规', NULL, 1, 0),
(5, 3, '陈嘉明', '男', '13810000005', 'chen@lingnan-law.example', '公司企业', '主任律师', 13, '长期担任大湾区企业法律顾问，擅长把商业目标转化为合同和治理规则。', '常年顾问、公司治理、商务合同', NULL, 1, 0),
(6, 3, '黄雅琪', '女', '13810000006', 'huang@lingnan-law.example', '知识产权', '知识产权律师', 7, '办理商标、著作权、不正当竞争案件，熟悉电商平台证据固定和维权流程。', '商标维权、著作权、不正当竞争', NULL, 1, 0),
(7, 4, '林启航', '男', '13810000007', 'lin@qianhai-law.example', '经济金融', '投融资律师', 11, '专注创业融资、股权激励和金融科技合规，能协助企业建立从融资到退出的文件体系。', '投融资、股权激励、金融科技合规', NULL, 1, 0),
(8, 4, '何婉宁', '女', '13810000008', 'he@qianhai-law.example', '涉外纠纷', '跨境业务律师', 8, '服务跨境电商与外贸企业，熟悉国际货物买卖、平台合规和跨境争议应对。', '跨境电商、国际贸易、平台合规', NULL, 1, 0),
(9, 5, '赵思远', '男', '13810000009', 'zhao@bingcheng-law.example', '劳动争议', '资深律师', 9, '专注劳动争议与企业合规，熟悉东北地区劳动仲裁与法院裁判尺度。', '劳动仲裁、员工安置、规章制度', NULL, 1, 0),
(10, 5, '孙雪', '女', '13810000010', 'sun@bingcheng-law.example', '民事民法', '诉讼律师', 6, '办理民间借贷、物业纠纷和建设工程小额争议，沟通细致，重视证据链完整性。', '民间借贷、物业纠纷、建设工程', NULL, 1, 0),
(11, 6, '钱雨桐', '女', '13810000011', 'qian@qiantang-law.example', '知识产权', '合伙人律师', 10, '服务软件、文创和平台经济客户，擅长知识产权保护、内容合规和商业秘密管理。', '软件著作权、商业秘密、平台合规', NULL, 1, 0),
(12, 6, '陆承泽', '男', '13810000012', 'lu@qiantang-law.example', '公司企业', '企业合规律师', 7, '帮助中小企业建立合同模板、授权审批和风险清单，适合需要长期规范化的客户。', '合同体系、企业合规、风险评估', NULL, 1, 0),
(13, 7, '罗安然', '女', '13810000013', 'luo@jincheng-law.example', '婚姻家事', '家事律师', 8, '关注离婚、继承和未成年人权益保护，善于在诉讼与调解之间寻找稳妥方案。', '离婚纠纷、继承、家庭财产分割', NULL, 1, 0),
(14, 7, '唐知行', '男', '13810000014', 'tang@jincheng-law.example', '房产纠纷', '民商事律师', 9, '处理房屋买卖、租赁和物业服务合同争议，熟悉成都本地不动产交易流程。', '房屋买卖、租赁纠纷、物业合同', NULL, 1, 0)
